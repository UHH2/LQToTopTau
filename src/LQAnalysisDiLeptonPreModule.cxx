 ...
 */
class LQAnalysisDiLeptonPreModule: public AnalysisModule {
public:
    
    explicit LQAnalysisDiLeptonPreModule(Context & ctx);
...
LQAnalysisDiLeptonPreModule::LQAnalysisDiLeptonPreModule(Context & ctx){
    ...
    cout << "Hello World from LQAnalysisDiLeptonPreModule!" << endl;
    ...
    */
    ...
    ntau_sel.reset(new NTauSelection(0,0));
...
bool LQAnalysisDiLeptonPreModule::process(Event & event) {
...
UHH2_REGISTER_ANALYSIS_MODULE(LQAnalysisDiLeptonPreModule)
